const Footer = () => {
  return (
      <footer className="footer footer-center bg-gradient-to-b from-rose-500 to-rose-700 rounded-t-3xl p-6 sm:p-10 text-white">
          <div className="container mx-auto px-4">
              ...
              <div className="flex justify-center mb-6">
                  <div className="flex gap-4">
                      ...
                      <a href="https://youtube.com" aria-label="YouTube" className="hover:text-gray-200">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
